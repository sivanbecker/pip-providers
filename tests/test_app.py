...
def test_delete_provider(client, _provider1_in_db):
    resp_delete = client.delete(f"{ProviderResource.BASE_ROUTE}/{_provider1_in_db.mispar_osek}")
...
def test_delete_non_existing_provider(client, _provider1_obj):
    resp_delete = client.delete(f"{ProviderResource.BASE_ROUTE}/{_provider1_obj.mispar_osek}")
